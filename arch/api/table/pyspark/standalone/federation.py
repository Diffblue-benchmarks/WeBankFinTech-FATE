...
from arch.api.table.eggroll.standalone.federation import FederationRuntime as StandaloneFederation
...
class FederationRuntime(object):
    ...
    def __init__(self, job_id, runtime_conf):
        self._eggroll_federation = StandaloneFederation(job_id, runtime_conf)
