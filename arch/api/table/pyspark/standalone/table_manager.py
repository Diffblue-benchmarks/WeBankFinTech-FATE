...
class RDDTableManager(TableManger):
    ...
    def __init__(self, job_id, eggroll_context):
        ...
        self.eggroll_table_manager = EggRollTableManager(job_id=job_id, eggroll_context=eggroll_context)
        ...
        # set eggroll instance for broadcast
        from arch.api import RuntimeInstance
        RuntimeInstance.EGGROLL = self.eggroll_table_manager._eggroll
