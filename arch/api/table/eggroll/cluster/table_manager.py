...
class EggRollTableManager(TableManager):
    """
    wrapper of :class:`arch.api.cluster.eggroll._EggRoll`
    """

    def __init__(self, job_id=None, server_conf_path="arch/conf/server_conf.json", eggroll_context=None):
        """
        wrapper of :class:`arch.api.cluster.eggroll._EggRoll`
        """
        from arch.api.cluster.eggroll import init
        self._eggroll = init(job_id, server_conf_path=server_conf_path, eggroll_context=eggroll_context)
